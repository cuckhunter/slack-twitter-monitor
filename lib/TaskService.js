...
const KEYWORDS_REG_EXP = new RegExp([
  '1488|anschluss|dolchsto(?:ß|ss)|ehrenarier|einsatzgruppen|endsieg|f[üu]hrerprinzip|gleichschaltung|gro(?:ß|ss)e l[üu]ge|judenfrei|lebensborn|lebensraum|l[üu]genpresse|kristallnacht|night of the long knives|sonderkommando',
  'accelerationis(?:m|ts?)',
  '(?:amy )?wax(?!e[ds]|ing)',
  ...
  '\\bhimmler|mengele|g[öo]e?ring|ilse koch|berchtold|bormann|heydrich|eichmann',
  'goy(?:s|im)?',
  '\\bhags?\\b',
  '(?<!boko )haram\\b',
  '(?:and )?\\bhere\'s why',
