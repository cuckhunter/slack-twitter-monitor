...
const KEYWORDS_REG_EXP = new RegExp([
  '1488|anschluss|dolchsto(?:ß|ss)|ehrenarier|einsatzgruppen|endsieg|f[üu]hrerprinzip|gleichschaltung|gro(?:ß|ss)e l[üu]ge|judenfrei|lebensborn|lebensraum|l[üu]genpresse',
  'accelerationis[mt]',
  ...
  'pencil[\\- ]?neck(?:ed|s)?',
  'pepes?|groypers?',
  '((?:red|blue|black|white)[\\- ]?|(?!< ))pill(?:s|ing|ed)?',
  // 'pizza',
  'please clap',
  'pounce(?:ing|[ds])?',
  'power[\\- ]?law',
