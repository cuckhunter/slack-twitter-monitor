...
async function app([$env, $logger, $server, $slackService, $taskService]) {
  ...
  // $taskService.runHighScoringTweetsTask('arthur_affect'), // protected
  ...
  $taskService.runHighScoringTweetsTask('IAmAdamRobinson', 'high'),
  ...
  $taskService.runHighScoringTweetsTask('piersmorgan', 'high'),
  $taskService.runHighScoringTweetsTask('CHSommers', 'high'),
  $taskService.runHighScoringTweetsTask('cathyyoung63', 'high'),
  $taskService.runHighScoringTweetsTask('clairlemon', 'high'),
  ...
  $taskService.runHighScoringTweetsTask('ewarren', 'high'),
  $taskService.runHighScoringTweetsTask('KamalaHarris'),
  $taskService.runHighScoringTweetsTask('SenGillibrand'),
  ...
  $taskService.runHighScoringTweetsTask('DrJillStein', 'high'),
