...
async function app([$env, $logger, $server, $slackService, $taskService]) {
  ...
  $taskService.runAllTweetsTask('davidfrum'),
  ...
  $taskService.runAllTweetsTask('benshapiro'),
  ...
  $taskService.runAllTweetsTask('RealJamesWoods'),
  ...
  $taskService.runAllTweetsTask('RichardBSpencer'),
  ...
  $taskService.runAllTweetsTask('robinhanson'),
  $taskService.runAllTweetsTask('tylercowen'),
  $taskService.runAllTweetsTask('ericgarland'),
