...
async function app([$env, $logger, $server, $slackService, $taskService]) {
  ...
  // $taskService.runPredictItTask(3481), // MT senator
  // $taskService.runPredictItTask(3608), // NV senator
  // $taskService.runPredictItTask(4555), // WI governor
  ...
  $taskService.runAllTweetsTask('NateSilver538'),
