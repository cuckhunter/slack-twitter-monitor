...
async function app([$env, $logger, $server, $slackService, $taskService]) {
  ...
  try {
    ...
    const settings = {
      ...
      'RealSaavedra': LOW,
      'seanmdav': LOW,
      // 'SohrabAhmari': DEFAULT, deactivated for lent
      'ScottMGreer': LOW,
      ...
      'TheRickWilson': DEFAULT,
      'prchovanec': DEFAULT,
      'monacharenEPPC': DEFAULT,
      'RadioFreeTom': LOW,
      'SykesCharlie': DEFAULT,
