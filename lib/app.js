...
async function app([$env, $logger, $server, $slackService, $taskService]) {
  ...
  try {
    ...
    const settings = {
      ...
      // 'ghostofchristo1': DEFAULT, // protected
      ...
      // 'balajis': HIGH,
      // 'naval': DEFAULT,
      // 'michaeljburry': HIGH, // deactivated
