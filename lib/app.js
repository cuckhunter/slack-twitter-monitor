...
async function app([$env, $logger, $server, $slackService, $taskService]) {
  ...
  $taskService.runHighScoringTweetsTask('KamalaHarris', 'high'),
  $taskService.runHighScoringTweetsTask('SenGillibrand', 'high'),
  $taskService.runHighScoringTweetsTask('AOC', 'high'),
  $taskService.runHighScoringTweetsTask('TulsiGabbard', 'high'),
  ...
  $taskService.runHighScoringTweetsTask('BretStephens', 'low'),
