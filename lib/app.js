...
async function app([$env, $logger, $server, $slackService, $taskService]) {
  ...
  $taskService.runAllTweetsTask('davidfrum', allTweetsInterval),
  ...
  $taskService.runAllTweetsTask('benshapiro', allTweetsInterval),
  ...
  // $taskService.runHighScoringTweetsTask('leighalexander', highScoringTweetsInterval),
      $taskService.runAllTweetsTask('stillgray', allTweetsInterval),
  ...
  $taskService.runAllTweetsTask('RichardBSpencer', allTweetsInterval),
  ...
  // $taskService.runHighScoringTweetsTask('RubinReport', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('kurteichenwald', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('EricRWeinstein', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('balajis', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('marcushjohnson', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('davidhogg111', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('funder', allTweetsInterval),
  $taskService.runAllTweetsTask('robinhanson', allTweetsInterval),
  $taskService.runAllTweetsTask('tylercowen', allTweetsInterval),
  // $taskService.runHighScoringTweetsTask('ericgarland', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('KyleKashuv', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('JackPosobiec', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('charliekirk11', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('scrowder', highScoringTweetsInterval),
  // $taskService.runHighScoringTweetsTask('HAGOODMANAUTHOR', highScoringTweetsInterval),
  $taskService.runAllTweetsTask('RealCandaceO', allTweetsInterval),
  // $taskService.runAllTweetsTask('GCTigerTracker', allTweetsInterval),
  $taskService.runHighScoringTweetsTask('NickJFuentes', highScoringTweetsInterval),
  //$taskService.runHighScoringTweetsTask('ScottPresler', highScoringTweetsInterval),
  //$taskService.runHighScoringTweetsTask('SageRosenfels18', highScoringTweetsInterval),
    ]);
