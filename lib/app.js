...
async function app([$env, $logger, $server, $slackService, $taskService]) {
  ...
  $taskService.runBestTweetsTask('robinhanson', allTweetsInterval),
  ...
  $taskService.runAllTweetsTask('NickJFuentes', highScoringTweetsInterval),
  //$taskService.runAllTweetsTask('ScottPresler', highScoringTweetsInterval),
    ]);
